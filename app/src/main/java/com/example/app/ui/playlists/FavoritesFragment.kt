...
import com.example.app.MediaPlayerPage
    ...
    private fun setupPlaylistsRecyclerView(view: View) {
        ...
        favPlaylistAdapter = PlaylistAdapter(
            ...
            onSoundClicked = { sound, playlistId ->
                ...
                val intent = Intent(requireContext(), MediaPlayerPage::class.java)
                intent.putExtra("sound_id", sound.id)
                intent.putExtra("playlist_id", playlistId) // optional if you need it later
